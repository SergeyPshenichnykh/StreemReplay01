    ...
    *,
    ...
    if list_totals_ladder or list_totals_one_line:
        ...
        if totals_sticky:
            ...
            want_lines = [float(x) + 0.5 for x in range(0, 8)]
        ...
        # This matches the main ladder dashboard style, not the compact numeric CS table.
        ...
        if cs_markets:
            ...
            for st in sorted(cs_markets, key=lambda s: s.market_id):
                ...
                # Keep the same CS ladder behavior as normal --ladder mode.
                ...
                # Many CS runners per row -> compact MY columns.
                ...
                for runner in runners_sorted:
                    ...
                    if len(cols_cs) >= max(1, int(cs_cols)):
                        print_columns(cols_cs, col_width=col_width)
                        print()
                        cols_cs = []
